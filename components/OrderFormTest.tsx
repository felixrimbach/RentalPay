...
import PaymentDetailsTest from './PaymentDetailsTest'
...
export default function OrderFormTest() {
  ...
  return (
    <div className="w-full flex flex-col md:flex-row gap-6 md:gap-8">
      <div className="bg-white rounded-2xl shadow-lg border-2 border-violet-300 p-6 md:p-8 flex-1">
        ...
        <label className="block font-semibold mb-2 text-xl text-[#4054A5]" htmlFor="PriceInfo">Per unit: USD 70 refundable, USD 5 Admin Fee (4 days rental)</label>
