...
export async function POST(request: NextRequest) {
    try {
        ...
        const html = `<!DOCTYPE html>
                    ...
                    <p style="font-size: 16pt; text-align: left;">Please note that USD 70 per device will be refunded once the device(s) is/are returned in a good condition. In order to receive the refund, you must return the device on August 26 by 11:30 AM Sydney time at Main Platform.</p>
